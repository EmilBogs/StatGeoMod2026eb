...
DMI.Stations <- read.csv("StationsWithClim.csv")
...
```{r plot-all-stations}
# Load world map
wrld_simpl <- rnaturalearth::ne_countries(type = "countries", scale = "large")
...
**Answer space:**
- Best method: Kriging
- Reason: It shows the best explanaition for the response variable in comparison to the null model. Also the MEan_RMSE is the lowest for this model, thus the predicted values are closer to the observed in comparison to the other models.
